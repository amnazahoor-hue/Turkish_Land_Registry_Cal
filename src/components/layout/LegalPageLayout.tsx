  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-surface pb-16 pt-24 sm:pt-28 md:pt-32">
        <article className="prose prose-slate page-container-narrow prose-headings:font-display prose-headings:text-primary prose-a:text-secondary max-w-3xl text-center lg:text-left">
